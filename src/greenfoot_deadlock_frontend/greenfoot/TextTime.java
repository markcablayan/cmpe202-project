...
public class TextTime extends Actor
{
    ...
    public TextTime(int timeBeforeEvent)
    {
        this(timeBeforeEvent, true);
    }
 
    public TextTime(int timeBeforeEvent, boolean getsStarted) // int value given in seconds
    {
